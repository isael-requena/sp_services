...
class UsuarioController extends AbstractController {
    ...
    public function register(UserPasswordEncoderInterface $encoder){
        ...
        if (isset($requestBody['usuario_creacion'])) {
            ...
            $user->setFecCreacion(new \DateTime('now'));
        ...
        if (isset($requestBody['usuario_modificacion'])) {
            ...
            $user->setFecModificacion(new \DateTime('now'));
    ...
    public function getTourList($id): Response{
        ...
        WHERE lista_recorrido.FEC_LISTA = CURRENT_DATE() AND persona.NUM_EMPLEADO ='.$user->getNumEmpleado().';';
