 ...
 * CsLegados
 *
 * @ORM\Table(name="cs_legados", indexes={@ORM\Index(name="FK_CS_LEGADOS_ESTATUS_MAESTROS", columns={"FK_ESTATUS_MAESTROS"})})
 * @ORM\Entity
 */
class CsLegados
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="CLIENTE", type="integer", nullable=true, options={"default"="NULL"})
     */
     ...
     * @var int|null
     *
     * @ORM\Column(name="ID_CS", type="integer", nullable=true, options={"default"="NULL"})
     */
    private $idCs = NULL;
     ...
     * @var string|null
     *
     * @ORM\Column(name="TIPO_DENOM", type="string", length=10, nullable=true, options={"default"="NULL"})
     */
    private $tipoDenom = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="COD_CIA", type="string", length=10, nullable=true, options={"default"="NULL"})
     */
    private $codCia = 'NULL';
     ...
     * @var string|null
     *
     * @ORM\Column(name="COD_OFI", type="string", length=10, nullable=true, options={"default"="NULL"})
     */
    private $codOfi = 'NULL';
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="FECHA_OPER", type="date", nullable=true, options={"default"="NULL"})
     */
    private $fechaOper = 'NULL';

    /**
     * @var int|null
     *
     * @ORM\Column(name="NUM_S47", type="integer", nullable=true, options={"default"="NULL"})
     */
    private $numS47 = NULL;
     ...
     * @var string|null
     *
     * @ORM\Column(name="NUM_ORD_VIEJ", type="string", length=15, nullable=true, options={"default"="NULL"})
     */
    private $numOrdViej = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="NUM_CTA", type="string", length=15, nullable=true, options={"default"="NULL"})
     */
    private $numCta = 'NULL';
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="FECHA_AUTOR", type="date", nullable=true, options={"default"="NULL"})
     */
    private $fechaAutor = 'NULL';

    /**
     * @var int|null
     *
     * @ORM\Column(name="NUM_AUTORIZ", type="integer", nullable=true, options={"default"="NULL"})
     */
    private $numAutoriz = NULL;

    /**
     * @var string|null
     *
     * @ORM\Column(name="COD_AGENCIA", type="string", length=10, nullable=true, options={"default"="NULL"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="TIPO_MOV", type="string", length=3, nullable=true, options={"default"="NULL"})
     */
    private $tipoMov = 'NULL';
    ...
    public function getFkEstatusMaestros(): ?EstatusMaestros
    {
