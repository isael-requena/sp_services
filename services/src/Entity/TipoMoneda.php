...
class TipoMoneda
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="COD_MONEDA", type="integer", nullable=true, options={"default"="NULL"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="DENOMINACION", type="string", length=5, nullable=true, options={"default"="NULL"})
     */
    private $denominacion = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="NB_TIPO_MONEDA", type="string", length=20, nullable=true, options={"default"="NULL"})
     */
    private $nbTipoMoneda = 'NULL';
