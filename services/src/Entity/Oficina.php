 ...
 * Oficina
 *
 * @ORM\Table(name="oficina", indexes={@ORM\Index(name="FK_OFICINA_COMPANIA", columns={"FK_COMPANIA"}), @ORM\Index(name="FK_OFICINA_REGION", columns={"FK_REGION"})})
 * @ORM\Entity
 */
class Oficina
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="COD_OFICINA", type="string", length=5, nullable=true, options={"default"="NULL"})
     */
    private $codOficina = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="NB_OFICINA", type="string", length=50, nullable=true, options={"default"="NULL"})
     */
    private $nbOficina = 'NULL';
