...
class Compania
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="COD_COMPANIA", type="string", length=5, nullable=true, options={"default"="NULL"})
     */
    private $codCompania = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="NB_CORTO_COMPANIA", type="string", length=10, nullable=true, options={"default"="NULL"})
     */
    private $nbCortoCompania = 'NULL';

    /**
     * @var string|null
     *
     * @ORM\Column(name="NB_COMPANIA", type="string", length=100, nullable=true, options={"default"="NULL"})
     */
    private $nbCompania = 'NULL';
