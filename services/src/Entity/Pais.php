...
class Pais
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="COD_PAIS", type="integer", nullable=true, options={"default"="NULL"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="NB_PAIS", type="string", length=50, nullable=true, options={"default"="NULL"})
     */
    private $nbPais = 'NULL';
