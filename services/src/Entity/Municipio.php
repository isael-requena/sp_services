 ...
 * Municipio
 *
 * @ORM\Table(name="municipio", indexes={@ORM\Index(name="FK_MUNICIPIO_CIUDAD", columns={"FK_CIUDAD"})})
 * @ORM\Entity
 */
class Municipio
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="COD_MUNICIPIO", type="integer", nullable=true, options={"default"="NULL"})
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="NB_MUNICIPIO", type="string", length=50, nullable=true, options={"default"="NULL"})
     */
    private $nbMunicipio = 'NULL';
