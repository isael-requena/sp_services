...
class TasaCambio
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="TASA", type="decimal", precision=12, scale=2, nullable=true)
     */
    private $tasa;
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="FEC_PROCESO", type="date", nullable=true)
     */
    private $fecProceso;
    ...
    public function getFecProceso(): ?\DateTimeInterface
    {
        return $this->fecProceso;
    }

    public function setFecProceso(?\DateTimeInterface $fecProceso): self
    {
