 ...
 * Estatus
 *
 * @ORM\Table(name="ESTATUS", indexes={@ORM\Index(name="IDX_B165869995E1363A", columns={"FK_TIPO_ESTATUS"})})
 * @ORM\Entity
 */
class Estatus
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="COD_ESTATUS", type="integer", nullable=true)
     */
    private $codEstatus;
     ...
     * @var string|null
     *
     * @ORM\Column(name="NB_ESTATUS", type="string", length=50, nullable=true)
     */
    private $nbEstatus;
     ...
     * @var string|null
     *
     * @ORM\Column(name="ESTATUS_MAESTRO", type="string", length=20, nullable=true)
     */
    private $estatusMaestro;
